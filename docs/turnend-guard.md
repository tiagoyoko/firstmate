...
That check keeps ship, scout, and final-reviewer linked worktrees inert because their git dir differs from their git common dir.
...
- Child ship, scout, and final-reviewer worktrees are outside scope.
