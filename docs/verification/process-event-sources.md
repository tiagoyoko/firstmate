...
| Muse | Muse remains a worktree-worker-only runtime, so no primary process-event integration exists; external adapters still run in the owning home, not in Muse. |
