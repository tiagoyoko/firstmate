...
omp publishes no marker of its own; `FM_OMP_HARNESS=omp` is Firstmate's launch marker, and `references/harness/omp.md` records its compiled and Bun-script ancestry evidence.
